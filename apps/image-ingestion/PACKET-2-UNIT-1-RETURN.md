...
- **Privileged administrators can still bypass.** Triggers and grants stop runtime roles and accidents. A superuser or table owner can disable a trigger. That is an administrative trust boundary, not immutability, and the P2-E revision in unit 2 still has to define it for production.
